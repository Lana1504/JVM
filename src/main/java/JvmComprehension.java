public class JvmComprehension {
    ...
    public static void main(String[] args) {
        ...
        Object o = new Object();
        // 2. В Куче создается объект Object, во фрейме main создается переменная o,
        // которой присваивается ссылка на объект.
    ...
    private static void printAll(Object o, int i, Integer ii) {
        ...
        // а во фрейме printAll появляется переменная uselessVar со ссылкой на объект.

        System.out.println(o.toString() + i + ii);
        // 6.  В Stack'е создается фрейм println,
        // туда передаются ссылки на Object o, int i , Integer ii.
